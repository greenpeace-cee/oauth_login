...
// Make CRM_oauth_login_ExtensionUtil available.
require_once __DIR__ . '/../../oauth_login.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('oauth_login');
 ...
 */
function _oauth_login_test_civicrm_container(ContainerBuilder $container): void {
}
